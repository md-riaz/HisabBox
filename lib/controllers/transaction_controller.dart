...
class TransactionController extends GetxController {
  ...
  final RxList<TransactionType> activeTransactionTypes =
      TransactionType.values.obs;
  ...
  Future<void> loadTransactions({
    ...
    try {
      final result = await DatabaseService.instance.getTransactions(
        ...
        transactionTypes: activeTransactionTypes.toList(growable: false),
        startDate: startDate,
        endDate: endDate,
        limit: limit,
      );
  ...
  Future<void> setActiveTransactionTypes(List<TransactionType> types) async {
    if (types.isEmpty) {
      return;
    }
    activeTransactionTypes.assignAll(types);
    await loadTransactions();
  }
