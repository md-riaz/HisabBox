...
#### `getTransactions({providers, transactionTypes, startDate, endDate, limit, offset})`
Retrieve transactions with optional filtering.

**Parameters:**
- `providers`: List<Provider>? - Filter by providers
- `transactionTypes`: List<TransactionType>? - Filter by transaction types
...
final transactions = await DatabaseService.instance.getTransactions(
  ...
  transactionTypes: [TransactionType.sent, TransactionType.payment],
